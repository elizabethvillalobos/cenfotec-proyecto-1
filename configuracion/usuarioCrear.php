				...
				<section>
					...
					<form id="modificar-usuario" class="mod-bd form-horizontal" action="/cenfotec-proyecto-1/configuracion/usuariosConsultar.php" method="post" data-validate="true" novalidate>
						...
						<div class="form-row">
							...
							<input id="usuario-apellidos" onkeypress="return soloLetras(event)" type="text" placeholder="Ingrese el primer" class="form-control" value="" required/>
						</div>
						
						<div class="form-row">
							<label for="usuario-apellidos">Segundo apellido:</label>
							<input id="usuario-apellidos" onkeypress="return soloLetras(event)" type="text" placeholder="Ingrese el segundo apellido" class="form-control" value="" required/>
						</div>
						...
						<div class="form-row">
							...
							<input id="usuario-horario" type="email" placeholder="" class="form-control" data-validate-type="email"/>
						</div>
