...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-08-2014 a las 06:36:37
...
(54, 'evillalobosm@ucenfotec.ac.cr', 'acordero@ucenfotec.ac.cr', '2014-08-26 12:00:00', '2014-08-26 12:30:00', 'ARBOLES', 1, 1, 'ARBOL DE GUANACASTE', 'BISOFT-04', 4, 1, '2014-08-26 04:27:54');
...
CREATE TABLE IF NOT EXISTS `tevaluaciones` (
  ...
  `idActor` varchar(50) NOT NULL,
  `realizada` tinyint(1) NOT NULL,
  PRIMARY KEY (`idCita`,`nota1`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Volcado de datos para la tabla `tevaluaciones`
--

INSERT INTO `tevaluaciones` (`idCita`, `nota1`, `nota2`, `nota3`, `nota4`, `nota5`, `idActor`, `realizada`) VALUES
(36, 0, 0, 0, 0, 0, '', 0),
(43, 0, 0, 0, 0, 0, '', 0);
