<?php
	...
	function modificarEvaluacion(){
		if (!empty($_GET['pradioSi']) && !empty($_GET['idCita']) && !empty($_GET['pnota2']) && 
			...
			$query = "UPDATE tevaluaciones SET nota2='$nota2',nota3='$nota3',nota4='$nota4',nota5='$nota5', realizada=1 WHERE idCita='$idCita' AND idActor='$idActor'";
            $result = do_query($query);
            deliver_response(200, 'OK', 'Evaluacion actualizada con exito');
		} else {
			deliver_response(400, 'Bad request', NULL);	
		}	
	}
